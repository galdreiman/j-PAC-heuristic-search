...
/**
 * Created by Gal Dreiman on 01/01/2018.
 */
public class GreedyAndDPSExperimentRunner {
    final static Logger logger = Logger.getLogger(GreedyAndDPSExperimentRunner.class);
    ...
    public void runExperimentBatch(Class[] domains,
        ...
        for (Class domainClass : domains) {
            logger.info("Running GreedyAndDPS for domain " + domainClass.getName());
            try {
